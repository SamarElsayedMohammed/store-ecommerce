<x-dashboard.layouts.admin-layout title="Shipping Method">
    ...
    <x-dashboard.layouts.breadcrumb page="Edit" pageTitle="Shipping Method">
        ...
        <x-slot:links>
            ...
            <li class="breadcrumb-item"><a href="#"><i class="lni lni-home"></i>options </a></li>
        </x-slot:links>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-tooltip">Edit:" {{ $option->name }} "</h4>
                        ...
                        <div class="card-content collapse show ">
                            ...
                            <div class="card-body">
                                <form class="form" action="{{ route('admin.options.update', $option->id) }}"
                                    ...
                                    @include('dashboard.options.__form')
